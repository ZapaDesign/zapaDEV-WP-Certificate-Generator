...
function zpdevwpcg_section_developers_callback( $args ) {
	?>
	<p id="<?php echo esc_attr( $args['id'] ); ?>"><?php esc_html_e( 'Follow the white rabbit.', 'zpdevwpcg' ); ?></p>
	<?php
}
...
function zpdevwpcg_field_director_cb( $args ) {
	...
	<select
		...
		data-custom="<?php echo esc_attr( $args['zpdevwpcg_custom_data'] ); ?>"
		name="zpdevwpcg_options[<?php echo esc_attr( $args['label_for'] ); ?>]">
		<option value="red" <?php echo isset( $options[ $args['label_for'] ] ) ? ( selected( $options[ $args['label_for'] ], 'red', false ) ) : ( '' ); ?>>
			<?php esc_html_e( 'red pill', 'zpdevwpcg' ); ?>
		</option>
		<option value="blue" <?php echo isset( $options[ $args['label_for'] ] ) ? ( selected( $options[ $args['label_for'] ], 'blue', false ) ) : ( '' ); ?>>
			<?php esc_html_e( 'blue pill', 'zpdevwpcg' ); ?>
		</option>
	</select>
	<?php
}
