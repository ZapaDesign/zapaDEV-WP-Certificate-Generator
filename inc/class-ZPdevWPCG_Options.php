    ...
    class Options
    {
        ...
        public function field_tuning (
            ...
            echo '<div class="zpwpcg-field-tuning__list">';
                ...
                if ($y_position): ?>
                    <div class="zpwpcg-field-tuning__item--y zpwpcg-field-tuning__item--range" data-param="<?php echo $field; ?>">
                ...
                if ($x_position): ?>
                    <div class="zpwpcg-field-tuning__item--x zpwpcg-field-tuning__item--range" data-param ="<?php echo $field; ?>">
                ...
                if ($fontsize):?>
                    <div class="zpwpcg-field-tuning__item">
                        ...
                        <input class="zpwpcg-field-tuning__item--font-size"
                               type="range"
                               step="0.1"
                               data-param ="<?php echo $field; ?>"
